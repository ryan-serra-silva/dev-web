...
public class SaqueTest {
    ...
    void deveRetornarErroQuandoContaForNula() {
        ...
        String resultado = AccountService.validarSaque(1L, BigDecimal.TEN, LocalTime.of(10, 0), accountDAO);
    ...
    void deveBloquearSaqueEntre12he12h30m() {
        ...
        String resultado = AccountService.validarSaque(1L, BigDecimal.TEN, LocalTime.of(12, 15), accountDAO);
    ...
    void deveBloquearSaqueEntre18he18h30m() {
        ...
        String resultado = AccountService.validarSaque(1L, BigDecimal.TEN, LocalTime.of(18, 10), accountDAO);
    ...
    void deveRetornarErroQuandoValorMenorQueMinimo() {
        ...
        String resultado = AccountService.validarSaque(1L, new BigDecimal("5"), LocalTime.of(10, 0), accountDAO);
    ...
    void deveRetornarErroQuandoValorMaiorQueMaximo() {
        ...
        String resultado = AccountService.validarSaque(1L, new BigDecimal("3000"), LocalTime.of(10, 0), accountDAO);
    ...
    void deveRetornarErroQuandoValorNaoMultiploDe10() {
        ...
        String resultado = AccountService.validarSaque(1L, new BigDecimal("25"), LocalTime.of(10, 0), accountDAO);
    ...
    void deveRetornarErroQuandoSaldoInsuficiente() {
        ...
        String resultado = AccountService.validarSaque(1L, new BigDecimal("100"), LocalTime.of(10, 0), accountDAO);
    ...
    void devePermitirSaqueValido() {
        ...
        String resultado = AccountService.validarSaque(1L, new BigDecimal("100"), LocalTime.of(9, 0), accountDAO);
